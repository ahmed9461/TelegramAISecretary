...
تغلق هذه المرحلة فجوات التدقيق فقط: لوحة المالك الفعلية، media basic handling، Rich Message مع fallback، ومعاينة/نشر الواجهة. بعدها تنفذ بوابة V1 الشاملة ولا يبدأ نطاق V1.1/V2 تلقائيًا.
