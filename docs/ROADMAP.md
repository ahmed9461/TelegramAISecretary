...
الحالة: **قيد الاختبار الحي قبل الدمج**.
...
معيار الإغلاق: نجاح الاختبارات الآلية + اختبار حي للتغذية الجماعية + Rich + contextual buttons + network resilience بدون ردود مكررة.
