...
في M6 يطلب من النموذج عدم إخراج HTML أو Markdown خام. عند الحاجة للبنية يستخدم عنوانًا نصيًا بسيطًا وأسطرًا ونقاط Unicode، ثم Telegram renderer يطبق native entities بصورة مستقلة.
