...
الحالة المسجلة في 2026-08-22: M6 مدمج في `main`، والتطوير الحالي M7 على `codex/m7-retrieval-quality` برأس migration `0005`. تحقق دائمًا من Git/Alembic لأن هذه الجملة ستصبح تاريخية عند إغلاق المرحلة.
