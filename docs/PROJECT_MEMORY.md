...
- بوابة Telegram الحية لـM7 نجحت في 2026-08-22؛ لا يدمج الفرع قبل CI البعيد والمراجعة.
...
نشر M7 إلى PR، تشغيل CI على Python 3.12/3.13، المراجعة والدمج. بعد ذلك يبدأ M8 على فرع مستقل لإضافة اقتراحات الذاكرة والتقييمات بموافقة صريحة، دون تعلم صامت.
